...
class AuthActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        firebaseConfig.setDefaultsAsync(mapOf("show_error_button" to false, "error_button_text" to "Probar"))
    ...
    private fun setup() {
       ...
       private fun showAlert() {
            ...
            builder.setMessage("Se ha producido un error autenticando al usuario. El email debe ser válido.")
